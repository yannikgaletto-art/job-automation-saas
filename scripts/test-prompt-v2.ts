...
const MOCK_STYLE = { tone: 'professional' as const, sentence_length: 'medium' as const, conjunctions: ['Daher'], greeting: 'Hallo,', rhetorical_devices: [] as string[], forbidden_constructs: [] as string[], uses_em_dash: false, max_commas_per_sentence: 2 };
