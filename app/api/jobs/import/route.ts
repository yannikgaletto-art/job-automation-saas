...
Schema: {"summary":"2-3 sentences in ${languageName}","responsibilities":["max 8"],"qualifications":["max 8"],"benefits":["TOP 6, max 3 words each"],"location":"string or null","seniority":"junior|mid|senior|lead|unknown","buzzwords":["MAXIMUM 18 ATS keywords extracted EXCLUSIVELY from the job description text below. HARD RULE: Each keyword MUST appear verbatim, as a direct translation, or as a clear semantic match in the JD text. If a keyword does NOT appear in the JD, you MUST NOT include it. Never invent keywords from your training data; never carry over keywords from prior tasks. CATEGORIES: tools, frameworks, platforms, certifications, domain terms. EXCLUDE: generic verbs, language names, soft skills, adjectives, JOB TITLES (acronyms like 'SDR', 'BDR', 'KAM', 'CEO/CFO/CTO/CMO' AND full titles like 'Sales Development Representative', 'Account Manager', 'Project Manager' — Skill is 'Project Management' or 'Sales Development', NOT the title that ends in Manager/Representative/Executive/Director), DOMAIN/THEME terms (medical conditions like 'Tinnitus', 'COPD', 'Diabetes'; topic areas alone), FORMAT terms ('Webinare', 'Workshops', 'Seminare', 'Konferenzen', 'Trainings', 'Schulungen'), VAGUE SOLO TERMS without skill content ('ICP', 'Enrichment', 'Playbooks' — only keep when paired like 'Lead Enrichment' or 'Sales Playbooks'). LANGUAGE: translate language-dependent terms into ${languageName} when an established translation exists (e.g. 'Project Management' → 'Projektmanagement' for de). Proper nouns and brand-specific tools keep their original form (Salesforce, SAP, Python, Scrum). Compliance-specific terms may translate as language variants of the same regulation: GDPR ↔ DSGVO ↔ RGPD."]}`,
