        ...
        if (resendKey) {
            ...
            try {
                ...
                if (!resendRes.ok) {
                    ...
                    console.error('[feedback/submit] Resend error:', resendRes.status, errBody);
                } else {
                    console.log('[feedback/submit] Resend OK →', resendRes.status);
                }
            } catch (err) {
                console.error('[feedback/submit] Resend fetch failed:', err);
            }
        }
