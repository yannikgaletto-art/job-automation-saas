...
import { Home, Search, Inbox, BarChart3, Users, Heart, Shield, Settings, MessageSquare, Mic, User, Compass } from 'lucide-react';
            ...
            <div className="min-h-screen bg-[#FAFAF9] flex">
                ...
                <Sidebar>
                    <NavSection title={t('nav_section.main')}>
                        ...
                        <NavItem icon={Compass} label={t('nav.initiativ')} href={`/${locale}/dashboard/initiativ`} />
