            ...
            >
                ...
                <div className="flex gap-3">
                    <div className="flex-1 relative">
                        ...
                        <input
                            type="text"
                            placeholder={searchMode === 'mission' ? t('placeholder_mission') : t('placeholder_keyword')}
                            value={query}
                ...
                {suggestedTitles.length > 0 && !isSearching && !hasSearches && (
                    <div className="mt-3 flex items-center gap-2 flex-wrap">
                        <span className="text-xs text-[#A8A29E] flex items-center gap-1">
                            <Sparkles className="w-3 h-3" /> {t('suggestions_label')}
                        </span>
                        ...
                        >
                            <div className="mt-4 pt-4 border-t border-[#E7E7E5] space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-xs font-medium text-[#73726E] mb-1.5 block">{t('filter_experience')}</label>
                                    ...
                                    <div>
                                        <label className="text-xs font-medium text-[#73726E] mb-1.5 block">{t('filter_org')}</label>
                                        <div className="flex gap-2">
                                            {ORG_TYPES.map(org => (
                                                <button
                                                    key={org}
                ...
                isSearching && (
                    <div className="flex flex-col items-center justify-center py-16 gap-4">
                        ...
                        <p className="text-sm text-[#73726E]">
                            {searchMode === 'mission' ? t('loading_mission') : t('loading_keyword')}
                        </p>
                    </div>
                )
            }
                    ...
                    <div className="sticky top-0 bg-white border-b border-slate-100 px-6 py-4 rounded-t-2xl z-10">
                        <div className="flex items-start justify-between">
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-slate-500 mt-0.5">{data.company_name} · {data.location || t('preview_location_unknown')}</p>
                                {stelleUrl && (
                                    <a
                                        href={stelleUrl}
                                        target="_blank"
                    ...
                    <div className="p-6 space-y-4">
                        ...
                        <div className="border border-slate-200 rounded-xl overflow-hidden">
                            ...
                            >
                                <span className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-semibold text-[#002e7a] uppercase tracking-wider">{t('preview_tasks_label')}</span>
                                            ...
                                            {editingField === 'tasks' ? (
                                                <div className="flex items-center gap-2 mt-1">
                                                    <input
                                                        ...
                                                        placeholder={t('preview_add_task_ph')}
                                                    />
                        ...
                        <div className="border border-slate-200 rounded-xl overflow-hidden">
                            ...
                            >
                                <span className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-[#002e7a]" />
                                    <span className="text-sm font-semibold text-[#002e7a] uppercase tracking-wider">{t('preview_reqs_label')}</span>
                                            ...
                                            {editingField === 'requirements' ? (
                                                <div className="flex items-center gap-2 mt-1">
                                                    <input
                                                        ...
                                                        className="flex-1 px-3 py-1.5 rounded-lg border border-slate-300 text-sm focus:outline-none focus:ring-1 focus:ring-[#002e7a]/30 focus:border-[#002e7a]"
                                                        placeholder={t('preview_add_req_ph')}
                                                    />
