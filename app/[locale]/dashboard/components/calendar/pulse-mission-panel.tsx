...
const PRIORITY_CONFIG = {
    high: { dot: 'bg-red-500', labelKey: 'priority_high' as const, bg: 'bg-red-50', border: 'border-red-200' },
    medium: { dot: 'bg-yellow-500', labelKey: 'priority_medium' as const, bg: 'bg-yellow-50', border: 'border-yellow-200' },
    low: { dot: 'bg-green-500', labelKey: 'priority_low' as const, bg: 'bg-green-50', border: 'border-green-200' },
};
