...
const CATEGORY_KEYS = [
    { value: '', labelKey: 'cat_all' },
    { value: 'social', labelKey: 'cat_social' },
    { value: 'environment', labelKey: 'cat_environment' },
    { value: 'education', labelKey: 'cat_education' },
    { value: 'health', labelKey: 'cat_health' },
    { value: 'culture', labelKey: 'cat_culture' },
] as const;
            ...
            >
                ...
                <div className="flex flex-wrap gap-2">
                    {QUICK_TAG_KEYS.map((tagKey) => {
                        const label = t(tagKey as Parameters<typeof t>[0]);
