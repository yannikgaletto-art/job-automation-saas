...
export function Step5Video({ jobId }: Step5VideoProps) {
        ...
        return (
            ...
            >
                <div className="w-14 h-14 bg-blue-50 rounded-full flex items-center justify-center mx-auto">
                    <Video className="w-7 h-7 text-[#012e7a]" />
                </div>
                <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Video-Vorstellung</h3>
                    <p className="text-sm text-gray-500 leading-relaxed">
                        Nimm ein kurzes <strong>1-Minuten-Video</strong> auf, das du per QR-Code auf deinem Lebenslauf verlinken kannst.
                        Die KI erstellt dir Talking Points, damit du weißt was du sagen sollst.
                    </p>
                    <p className="text-xs text-gray-400 mt-3">
                        Das Video ist <strong>14 Tage</strong> verfügbar und wird danach automatisch gelöscht. DSGVO-konform.
                    </p>
                </div>
                <button
                    onClick={handleConsent}
                    className="px-6 py-3 bg-[#012e7a] hover:bg-[#012e7a]/90 text-white font-medium rounded-lg transition w-full"
                >
                    Los geht&apos;s
                </button>
            </motion.div>
