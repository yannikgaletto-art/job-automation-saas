...
const COMMUNITIES = [
    {
        ...
        gradient: 'from-blue-100/60 to-indigo-200/60',
        iconColor: 'text-blue-500',
        hoverBorder: 'hover:border-blue-200',
        image: '/images/community/skill-share.png',
    },
    {
        slug: 'career',
        icon: HelpCircle,
        ...
        gradient: 'from-amber-100/60 to-orange-200/60',
        iconColor: 'text-amber-500',
        hoverBorder: 'hover:border-amber-200',
        image: '/images/community/career.png',
    },
    {
        ...
        gradient: 'from-emerald-100/60 to-teal-200/60',
        iconColor: 'text-emerald-500',
        hoverBorder: 'hover:border-emerald-200',
        image: '/images/community/entrepreneurship.png',
    },
] as const;
...
function CommunitySearch() {
    ...
    const doSearch = async (q: string) => {
        ...
        try {
            ...
            // Search endpoint may not exist yet — silent fallback
        } finally {
            setSearching(false);
        }
    };
...
export default function CommunityHubPage() {
    return (
        <div className="space-y-6 pb-12 max-w-5xl mx-auto">
            ...
            >
                <h1 className="text-3xl font-semibold text-[#37352F]">Community</h1>
                <p className="text-[#73726E] mt-1">
                    Lerne, teile und vernetze dich mit der Pathly-Community.
                </p>
            </motion.div>
                ...
                {COMMUNITIES.map((cat) => {
                    ...
                    return (
                        <motion.div key={cat.slug} variants={cardVariants}>
                            <Link
                                href={`/dashboard/community/${cat.slug}`}
                                className="block group h-full"
                            >
                                <div
                                    className={`h-full min-h-[240px] flex flex-col rounded-xl border border-[#E7E7E5] bg-white shadow-sm transition-all duration-300 ${cat.hoverBorder} hover:shadow-md cursor-pointer overflow-hidden`}
                                >
                                    {/* Image Header */}
                                    <div
                                        className="relative h-[140px] flex-shrink-0 overflow-hidden rounded-t-xl"
                ...
                <motion.div variants={cardVariants}>
                    <div className="h-full min-h-[240px] flex flex-col rounded-xl border border-[#E7E7E5] bg-white shadow-sm overflow-hidden opacity-60 cursor-default">
                        ...
                        <div className="flex flex-col flex-1 p-5">
                            ...
                            <p className="text-sm text-[#73726E] mt-1 leading-relaxed flex-1">
                                Erstelle deine eigene Community zu einem Thema deiner Wahl.
                            </p>
                            <div className="mt-3">
            ...
            <motion.div
                ...
                className="bg-[#F7F7F5] rounded-xl border border-[#E7E7E5] px-6 py-4"
            >
                <p className="text-sm text-[#73726E]">
                    <span className="font-medium text-[#37352F]">Community V1</span>
                    {' — '}
                    Die Community ist neu. Sei einer der Ersten, die aktiv beitragen und die Richtung mitgestalten.
                </p>
            </motion.div>
        </div>
    );
