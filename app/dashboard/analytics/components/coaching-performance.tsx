        ...
        return (
            ...
            >
                ...
                <p className="text-sm font-medium text-[#37352F] mb-1">
                    Noch keine Interview-Sessions
                </p>
                <p className="text-xs text-[#73726E] mb-4 max-w-xs mx-auto">
                    Schließe dein erstes Coaching-Interview ab, um hier deine Fortschritte zu sehen.
                </p>
                <Link
                    href="/dashboard/coaching"
                    className="inline-block text-xs font-medium text-[#002e7a] hover:underline"
                >
                    Zum Interview Coaching →
                </Link>
            </motion.div>
        );
    }
    ...
    return (
        ...
        >
            ...
            <p className="text-[10px] text-stone-400">
                Basierend auf {completed.length} abgeschlossenen Interview-Sessions
            </p>
        </motion.div>
    );
}
