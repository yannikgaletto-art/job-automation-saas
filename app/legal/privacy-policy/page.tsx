...
export default function PrivacyPolicyPage() {
    return (
        <div className="max-w-4xl mx-auto p-8 font-sans text-[#37352F]">
            <h1 className="text-3xl font-bold mb-2">Datenschutzerklärung / Privacy Policy</h1>
            <p className="text-sm text-gray-600 mb-8">Version 1.0 | Stand: März 2026</p>
            ...
            <div className="border-t border-[#E7E7E5] mt-10 pt-6 text-sm text-[#73726E]">
                <p>Letzte Aktualisierung: März 2026 | Version 1.0</p>
            </div>
        </div>
    )
}
